        ...
        c.addMessageListener(new Bead() {
            ...
            protected void messageReceived(Bead message) {
                ...
                if(c.getCount() % 12 == 0) {
                    ...
                    s1GainEnv.addSegment(0, 1000);
                    s1FMRatio.clear().setValue(3.2f);
                    s1FMRatio.addSegment(5, 100);
                    s1FMDepth.clear().setValue(0.1f);
                    s1FMDepth.addSegment(1, 500);
...
//                    s2GainEnv.addSegment(0, 500);
//                    s2FMRatio.clear().setValue(3.2f);
//                    s2FMDepth.clear().setValue(0.5f);
//                    s2LFORate.clear().setValue(0.1f);
//                    s2LFODepth.clear().setValue(0.2f);
//                }
                if(c.getCount() % 16 == 12 - (stepper2 % 2) * 4) {
                    stepper2++;
                    int odd = stepper2 % 2;
                    s2Freq.clear().setValue(Pitch.mtof(36 + (stepper2 % 8) * 2));
                    s2GainEnv.clear().setValue(0.2f);
                    s2GainEnv.addSegment(0, 800);
                    s2FMRatio.clear().setValue(12.5f * odd + 1);
                    s2FMRatio.addSegment(1, 100);
                    s2FMDepth.clear().setValue(0.5f);
                    s2LFORate.clear().setValue(0.1f);
                    s2LFODepth.clear().setValue(0.2f);
                }
